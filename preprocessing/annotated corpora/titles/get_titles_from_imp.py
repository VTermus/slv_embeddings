...
def extract_metadata(file_path):
    ...
    try:
        ...
        title = title_stmt.find('tei:title', ns).text.split(': ')[1] if title_stmt is not None else "Unknown Title"
        author = title_stmt.find('tei:title', ns).text.split(': ')[0] if title_stmt is not None else "Unknown Author"
...
rename_xml_files('IMP-corpus-tei')
